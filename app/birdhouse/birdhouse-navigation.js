                        ...
                        <div class="nav-bar" id="nav-bar-1">
                            <div class="controls">
                                ...
                                <span id="stream" onclick="toggleFloatingLowRes();" class="nav-on">
                                    <img id="streamToggle" src="birdhouse/img/camera.png" class="nav-img" title="`+lang('SHOW_STREAM')+`">
                                    <img id="streamToggle_black" src="birdhouse/img/camera_black.png" class="nav-img" title="show stream" style="display:none;">
                                </span>

                                <span id="moveUp_off" class="nav-off">`+img_up+`</span>
                                <span id="moveUp" class="nav-on" title="`+lang('PAGE_SCROLL_TOP')+`" style="display:none;" onclick="window.scrollTo(0,0);">`+img_up_full+`</span>

                                <span id="moveBack_off" class="nav-off">`+img_back+`</span>
                                <span id="moveBack" class="nav-on" title="`+lang('PAGE_BACK')+`" style="display:none;" onclick="birdhousePrint_page('PAGE_HISTORY|1');">`+img_back_full+`</span>

                                <span id="moveForth_off" class="nav-off">`+img_forth+`</span>
                                <span id="moveForth" class="nav-on" title="`+lang('PAGE_FORWARD')+`" style="display:none;" onclick="birdhousePrint_page('PAGE_HISTORY|-1');">`+img_forth_full+`</span>
                            </div>
                        </div>
                    </div>
