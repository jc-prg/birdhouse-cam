...
function birdhouse_INDEX(data, camera, object=false) {
    ...
    console.log("---> birdhouse_INDEX: selected:" + camera + " / app_active:" + app_active_cam + " / view_active:" + active_camera + " / view:" + index_view + " / other:" + other_cams.length );
    ...
    if (active_cam != {} && active_cam["name"]) {
        ...
        if (index_view != "picture-in-picture" || other_cams.length == 0) {
