...
cache_manifest_dir = [ "./", "./birdhouse/" ]
replace_dir        = [ "./", "./birdhouse/" ]
replace_text       = [
#	[ "appPrintMenu", "appPrint_menu" ], # sample
	[ "setRecycle", "birdhouse_setRecycle" ],
	[ "setFavorit", "birdhouse_setFavorit" ],
	[ "createShortVideo", "birdhouse_createShortVideo" ],
